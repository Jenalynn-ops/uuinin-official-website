  ...
  return <div className="mt-[26px]">
    <div className="px-[10px]">
      <div className="bg-[#0E0E0E] flex justify-between py-[21px] px-[10px] rounded-[4px]">
        ...
        <div className="flex">
          <div className="w-[78px] mr-[11px] h-[25px] border-[0.3px] border-[#006FFF]/90 rounded-[5px] flex justify-center items-center text-[8px] font-[600]">商家入驻</div>
          <div className="w-[78px] h-[25px] border-[0.3px] border-[#006FFF]/90 rounded-[5px] flex justify-center items-center text-[8px] font-[600]">联系我们</div>
        </div>
      </div>
    </div>
    <div className="px-[20px] flex justify-between items-center pt-[24px]">
      <div>
        ...
        <div className="text-[8px] text-white/60 mt-[7px]">Your Personal AI Shopping Advisor</div>

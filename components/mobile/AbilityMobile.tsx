...
export default function AbilityMobile() {
  ...
  return <div className="pt-[25px]">
    ...
    <div className="mt-[22px] bg-[#111111] py-[18px] px-[5px] flex flex-col items-center rounded-[10px]">
      <div className="text-[15px] font-[700]">{content.title}</div>
      <div className="text-[10px] font-[600] mt-[12px] text-white/80 leading-[14px]">{content.content1}</div>
      <div className="text-[10px] font-[600] text-white/80 leading-[14px]">{content.content2}</div>
      <div className="text-[10px] font-[600] text-white/80 leading-[14px]">{content.content3}</div>
    </div>
  </div>
}